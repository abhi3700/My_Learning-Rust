...
/// props for drawing a circular progress bar in anti-clockwise direction
pub fn create_circular_progress_bar_acw(
	diameter: f64,
	margin_top: i32,
	margin_bottom: i32,
	margin_start: i32,
	...
	drawing_area.borrow().set_draw_func({
		...
		move |_, cr, width, height| {
			...
			// NOTE: To change the direction from CW to ACW,just change the `percentage` with `(1 -
			// percentage)` to reverse the direction in terms of angle.
			cr.arc(
				center_x,
				center_y,
				diameter / 2.0,
	...
	// NOTE: There is a calculation required to change the arc by step-size.
	// 		To do this calculation, consider: `time_interval`, `step-size` (0.1 in this case).
	...
	glib::timeout_add_seconds_local(1, {
		...
		move || {
			...
			// NOTE: To change the direction from CW to ACW,just change the `percentage` with
			// `percentage - 0.1` where, 0.1 is the step-size to decrease the progress.
...
/// props for drawing a circular progress bar in clockwise direction
pub fn create_circular_progress_bar_cw(
	diameter: f64,
	margin_top: i32,
	margin_bottom: i32,
	margin_start: i32,
